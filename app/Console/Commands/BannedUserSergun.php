...
class BannedUserSergun extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:banned-user-sergun';
     ...
     * @var string
     */
    protected $description = 'Insert to table Banned_User after 1 hour not send photo for serbaguna';

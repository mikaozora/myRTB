    ...
    <div class="wrap-sidebar">
        <div class="wrap-content-sidebar">
            ...
            <div class="content-sidebar">
                <a href="/penghuni/forum" class="card-sidebar {{Request::is('penghuni/forum') ? 'active' : ''}}">
                ...
                <a href="/penghuni/mesincuci" class="card-sidebar {{Request::is('penghuni/mesincuci') ? 'active' : ''}}">
                ...
                <a href="/penghuni/coworking" class="card-sidebar {{Request::is('penghuni/coworking') ? 'active' : ''}}">
                ...
                <a href="/penghuni/serbaguna" class="card-sidebar {{Request::is('penghuni/serbaguna') ? 'active' : ''}}">
                ...
                <a href="/penghuni/dapur" class="card-sidebar {{Request::is('penghuni/dapur') ? 'active' : ''}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" viewBox="0 0 24 24"
                        fill="none">
                        <path
                ...
                <a href="/penghuni/theatre" class="card-sidebar {{Request::is('penghuni/theatre') ? 'active' : ''}}">
                ...
                <a href="/penghuni/report" class="card-sidebar {{Request::is('penghuni/report') ? 'active' : ''}}">
                ...
                <a href="/penghuni/history" class="card-sidebar {{Request::is('penghuni/history') ? 'active' : ''}}">
                    <svg id="history" xmlns="http://www.w3.org/2000/svg" width="40" height="25"
                        viewBox="0 0 25 25" fill="none">
                        <g clip-path="url(#clip0_192_1075)">
                            <path
                                d="M5.87083 19.1292C7.40463 20.663 9.42285 21.6175 11.5815 21.83C13.7402 22.0425 15.9058 21.4999 17.7093 20.2946C19.5127 19.0893 20.8424 17.2959 21.4717 15.2201C22.1011 13.1442 21.9911 10.9144 21.1606 8.91056C20.3301 6.90672 18.8304 5.25288 16.9171 4.23087C15.0038 3.20886 12.7954 2.88194 10.668 3.30581C8.54072 3.72968 6.62621 4.87811 5.25076 6.5554C3.87532 8.23268 3.12406 10.335 3.125 12.5042V14.5833"
                                stroke="#currentColor" stroke-width="2.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M1.0415 12.5L3.12484 14.5833L5.20817 12.5M11.4582 8.33331V13.5416H16.6665"
                                stroke="#currentColor" stroke-width="2.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </g>
                        <defs>
                            <clipPath id="clip0_192_1075">
